import{a as E,i as f,A as G,S as K,N as Q,P as Z,b as J}from"./assets/vendor-U7RKvRu8.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function s(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(o){if(o.ep)return;o.ep=!0;const r=s(o);fetch(o.href,r)}})();const I=document.querySelector(".loader-more"),P=document.querySelector(".loader-more-container"),D=document.querySelector(".furniture-list"),T=document.querySelector(".load-more-btn");let l=1,d=null;const $=8;window.allFurnitures=window.allFurnitures||[];async function Y(){try{const t=(await E("https://furniture-store.b.goit.study/api/categories")).data;t.unshift({_id:"0",name:"Всі товари"}),document.querySelectorAll(".category-card").forEach((n,o)=>{const r=t[o];if(!r)return;n.dataset.id=r._id;const c=n.querySelector(".category-title");c&&(c.textContent=r.name)})}catch{f.show({message:"Sorry, something went wrong. Please try again!",position:"topRight",messageColor:"#fff",titleColor:"#fff",color:"#ef4040",iconUrl:"../images/our-furniture/bi_x-octagon-2.svg",maxWidth:432})}}async function v(e=1,t){try{ne(),M();let s=`https://furniture-store.b.goit.study/api/furnitures?limit=${$}&page=${e}`;t&&t!=="0"&&(s+=`&category=${t}`);const o=(await E(s)).data;ee(o),d===null&&(d=Math.ceil(o.totalItems/$)),e>=d?M():re()}catch{f.show({message:"Sorry, something went wrong. Please try again!",position:"topRight",messageColor:"#fff",titleColor:"#fff",color:"#ef4040",iconUrl:"../images/our-furniture/bi_x-octagon-2.svg",maxWidth:432})}finally{oe()}}function ee(e){const t=e.furnitures;window.allFurnitures=[...new Map([...window.allFurnitures,...t].map(n=>[n._id,n])).values()];const s=t.map(n=>{const{_id:o,name:r,description:c,price:U,images:X}=n;return`
...
</li>`}).join("");D.insertAdjacentHTML("beforeend",s)}async function te(e){const t=e.target.closest(".category-card");if(!t)return;document.querySelectorAll(".category-card.active").forEach(n=>n.classList.remove("active")),t.classList.add("active");const s=t.dataset.id;ie(),l=1,s==="0"?(d=null,v(l)):(d=null,v(l,s))}function se(){l+=1,v(l)}function ne(){I.classList.remove("hidden"),P.style.display="flex"}function oe(){I.classList.add("hidden"),P.style.display="none"}function re(){T.classList.remove("hidden")}function M(){T.classList.add("hidden")}function ie(){D.innerHTML="",window.allFurnitures=[]}const ae=document.querySelector(".categories-list"),ce=document.querySelector(".load-more-btn");ce.addEventListener("click",se);ae.addEventListener("click",te);Y();v(l);document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".hero__button"),t=document.querySelector("#reviews");e&&t&&e.addEventListener("click",()=>{t.scrollIntoView({behavior:"smooth",block:"start"})})});const S=document.querySelector("[data-menu]"),O=document.querySelector("[data-menu-open]"),le=document.querySelector("[data-menu-close]"),de=document.querySelectorAll(".mobile-nav-list a, .mobile-btn");function ue(){S.classList.add("is-open"),document.body.style.overflow="hidden",document.addEventListener("keydown",V),document.addEventListener("click",F)}function y(){S.classList.remove("is-open"),document.body.style.overflow="",document.removeEventListener("keydown",V),document.removeEventListener("click",F)}function V(e){e.key==="Escape"&&y()}function F(e){!S.contains(e.target)&&!O.contains(e.target)&&y()}O.addEventListener("click",ue);le.addEventListener("click",y);de.forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const s=e.getAttribute("href"),n=document.querySelector(s);n&&(y(),n.scrollIntoView({behavior:"smooth"}))})});const me=`<div id="order-backdrop" class="backdrop" aria-hidden="true">
  <div
    class="modal-order"
    role="dialog"
